$(function() {
		...
		if(socket.username == null){
			...
			saveUser.click(function(){
				...
				if(uname == ""){
					...
					socket.emit('new user', {"room_id" : room_id,"username" : uname,"usercolor":usercolor});
				}
	...
	chatform.on('submit', function(e) {
		...
		if (message.val().trim().length) {
			...
			displayMessage(message.val(), socket.username, socket.usercolor, moment());
...
//			'</span>' +
		'<div class="chat-body pull-'+ who +' clearfix">' +
			'<div class="header">' +
				'<b class="primary-font" style="color:'+color+'">John Doe</b>' +
